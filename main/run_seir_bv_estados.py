...
data.to_csv('/srv/shiny-server/covidApp/data/model_data/data_seir_bv_estados.csv', index = False)
output_par.to_csv('/srv/shiny-server/covidApp/data/model_par/par_seir_bv_estados.csv', index = False)
output_data.to_csv('/srv/shiny-server/covidApp/data/model_comp/compartimentos_seir_bv_estados.csv', index = False)
