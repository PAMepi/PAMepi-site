...
data.to_csv('/srv/shiny-server/covidApp/data/model_data/data_seiir_estados.csv', index = False)
output_par.to_csv('/srv/shiny-server/covidApp/data/model_par/par_seiir_estados.csv', index = False)
output_data.to_csv('/srv/shiny-server/covidApp/data/model_comp/compartimentos_seiir_estados.csv', index = False)
