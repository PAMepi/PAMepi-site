...
def create_output(data):
    ...
    model = sir.start_model(pop = population)
...
data.to_csv('/srv/shiny-server/covidApp/data/model_data/data_sir_bv_estados.csv', index = False)
output_par.to_csv('/srv/shiny-server/covidApp/data/model_par/par_sir_bv_estados.csv', index = False)
output_data.to_csv('/srv/shiny-server/covidApp/data/model_comp/compartimentos_sir_bv_estados.csv', index = False)
